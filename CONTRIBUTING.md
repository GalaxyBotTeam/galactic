...
We recommend using [Visual Studio Code](https://code.visualstudio.com) with the official TypeScript and ESLint extensions for the best developer experience.
...
- [Issue Tracker](https://github.com/GalaxyBotTeam/galactic.ts/issues) — Report bugs or request features
- [Discord Server](https://discord.gg/galaxybot) — Join our community for support and discussions
